...
Scenario: When I call rescale-images view on an empty folder, nothing happens
  Given I am logged in as a Manager
   When I call rescale-images view on '${TEST_FOLDER}'
   Then Nothing happens on '${TEST_FOLDER}'

Scenario: When I call rescale-images view on a folder, all images are rescaled
  Given I am logged in as a Manager
...
Scenario: When I call rescale-images view on the Plone site, all images are rescaled
  Given I am logged in as a Manager
   When I go to the control panel
    And I access collective.autoscaling settings
    And I disabled autoscaling
   ...
   When I call rescale-images view on '${PLONE_URL}'
